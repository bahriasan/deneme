...
public class Main {
	...
	public static void main(String[] args) {
		...
		Product product1 =new Product(1,"Lenovo V14",15000, "16 GB RAM"); //Referans oluþturma, instance oluþturma
		...
		Product product3 =new Product(); //Referans oluþturma, instance oluþturma
		product3.id=3;
